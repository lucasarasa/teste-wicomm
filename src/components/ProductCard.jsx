...
function ProductCard({ product = DEFAULT_PRODUCT, compact = false }) {
  ...
  if (compact) {
    return (
      <article className="bg-cream my-1 flex w-[169px] shrink-0 flex-col overflow-hidden rounded-3xl shadow-[0_3px_15px_rgba(0,0,0,0.07)]">
  ...
  return (
    <article className="bg-cream flex w-56 shrink-0 flex-col items-center gap-3 overflow-hidden rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.05)]">
